...
For my final 6 months of engineering undergraduate studies I had to complete a research project in an electrical engineering related field. In most cases these project only serve as a testbed and are typically not used afterwards. In my case, a lecture and I came up with an idea. We proposed a research project where I would attempt to develop a test grading system for the applied mathematics department. Their current system required custom multiple-choice template paper, which was expensive. Furthremore, it seemed that test grading software in general had really not progressed much in the last few years. They wanted a solution that made use of new invations in deep learning to allow students to fill in decimal-valued answers. To solve this issue, I studied up image processing, probabilistic graphical models and neural networks.
